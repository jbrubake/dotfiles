...
" vim-spell:               Multiple spellfile 'levels'                                            plugurl:jbrubake/vim-spell " {{{3
...
function! NeatFoldText()
    ...
    let foldtextstart = strpart('+' . repeat(foldchar, v:foldlevel*2) . line, 0, winwidth(0)-strlen(lines_count_text))
